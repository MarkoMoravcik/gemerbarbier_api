...
public class ReservationDatesConfigConstants {
    ...
    public static final String BASIC_CUT_COLOR = "green";
    ...
    public static final String BASIC_BEARD_COLOR = "indigo";
    ...
    public static final String EXCLUSIVE_CUT_COLOR = "red";

    public static final String EXCLUSIVE_CUT_NAME = "Exclusive strih";
