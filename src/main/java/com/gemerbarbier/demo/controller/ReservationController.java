...
import com.gemerbarbier.demo.repository.ReservationRepository;
...
public class ReservationController {
    ...
    @RequestParam(name = "cutTag", required = true) @NotNull String cutTag
        ...
        surname(surname).email(email).phoneNumber(phoneNumber).note(note).cutType(cutType).cutTag(cutTag).build();
